...
furtherReading:
  - title: "Why AWS SES Denied Prod Access (And the 5 Reddit Alternatives)"
    href: "/blog/aws-ses-alternatives"
  - title: "CSS width: stretch — fill-available successor"
    href: "/l/width-stretch"
  - title: "CSS grid-lanes — mixed-height cards, not newspaper columns"
    href: "/l/grid-lanes"
  - title: "Snipsco — the tool itself"
...
I've been a front-end developer for quite a long time (not an indie hacker, or at least I didn't use to be); back then (when I started), <a href="/blog/deprecated-html-early-web">table layouts</a> came before <a href="/l/flexbox-align">flexbox</a> entered my toolbox, so I'm _basically_ a senior developer trying to _keep a foot in the fast-changing world of AI coding_.
...
Shipping a SaaS surface also means wrestling with email infrastructure; on [Zipitly](https://zipitly.com) I wrote about <a href="/blog/aws-ses-alternatives">SES production access and the providers we looked at instead</a>.
